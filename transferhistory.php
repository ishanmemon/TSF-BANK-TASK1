...
<body>
        ...
        <div class="collapse navbar-collapse nav justify-content-end" id="navbarLinks">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a href="#" class="nav-link active text-capitalize navhover">transfer history</a>
                </li>
            </ul>
        </div>
        </div>
    ...
    <!--end of navbar-->
     ...
     <div class="container py-2">
        <h3 class="text-center text-uppercase pt-4">payment history</h3>
        <div class="row py-2">
            <div class="col">
                <table class="table table-striped table-hover table-sm table-bordered table-condensed">
                    <thead>
                        <tr>
                            <th scope="col" class="text-center text-capitalize">s.no.</th>
                            <th scope="col" class="text-center text-capitalize">sender</th>
                            <th scope="col" class="text-center text-capitalize">receiver</th>
                            <th scope="col" class="text-center text-capitalize">amount</th>
                            <th scope="col" class="text-center text-capitalize">date & time</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
                        ...
                        $query = "select * from transfermoney";
                        ...
                        ?>
                            ...
                            <th class="py-2"><?php echo $row['sno']?></th>
                            <td class="py-2 text-uppercase"><?php echo $row['sender']?></td>
